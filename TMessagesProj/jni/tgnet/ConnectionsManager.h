...
public:
    ...
    void setProxySettings(std::string address, uint16_t port, std::string username, std::string password, std::string secret, int32_t type = 0);
    ...
    int64_t checkProxy(std::string address, uint16_t port, std::string username, std::string password, std::string secret, int32_t type, onRequestTimeFunc requestTimeFunc, jobject ptr1);
    int64_t checkProxy(std::string address, uint16_t port, std::string username, std::string password, std::string secret, onRequestTimeFunc requestTimeFunc, jobject ptr1) {
        return checkProxy(address, port, username, password, secret, 0, requestTimeFunc, ptr1);
    }
